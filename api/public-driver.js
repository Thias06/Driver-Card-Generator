// GET /api/public-driver?slug=tonton
// Affiche la Driver Card publique depuis Supabase.
// Nom volontairement différent de driver.js pour éviter le problème de détection Vercel actuel.
...
<body>
  <main class="wrap">
    ...
    return res.status(500).send(`Erreur public-driver: ${esc(e && e.message ? e.message : e)}`);
  }
};
